...
export { PBXContainerItemProxy } from "./PBXContainerItemProxy";
export { PBXFileReference } from "./PBXFileReference";
export { PBXFileSystemSynchronizedGroupBuildPhaseMembershipExceptionSet } from "./PBXFileSystemSynchronizedGroupBuildPhaseMembershipExceptionSet";
export { PBXFileSystemSynchronizedBuildFileExceptionSet } from "./PBXFileSystemSynchronizedBuildFileExceptionSet";
export { PBXFileSystemSynchronizedRootGroup } from "./PBXFileSystemSynchronizedRootGroup";
export { PBXLegacyTarget } from "./PBXLegacyTarget";
export { PBXNativeTarget } from "./PBXNativeTarget";
export { PBXProject } from "./PBXProject";
